...
function changeTab1Class(elClass) {
  ...
  for (var i = 0; i < tab1Length; i++) { 
    document.getElementsByClassName("tab1row")[i].className = "row tab1row tabInactive"; 
  } 
  elClass.className = "row tab1row tabActive";   
}
...
function changeTab2Class(elClass) {
  ...
  for (var i = 0; i < tab2Length; i++) { 
    document.getElementsByClassName("tab2row")[i].className = "row tab2row tabInactive"; 
  } 
  elClass.className = "row tab2row tabActive";   
}
...
function changeTab3Class(elClass) {
  ...
  for (var i = 0; i < tab3Length; i++) { 
    document.getElementsByClassName("tab3row")[i].className = "row tab3row tabInactive"; 
  } 

  elClass.className = "row tab3row tabActive";   
}
			...
			if (res.length > 0){
				...
				for(let i=0; i<res.length; i++){
					let applicRecHTML = '<tr id="rowApplic-'+ res[i].applicant.applicantID +'" class="row-applic" style="font-size: 14px;">'
										...
										+ '</td>'
										+ '<td style="font-size: 14px;">'
											+ '<div id="res-viewBtn" onclick="downloadFile('+ "\'" + res[i].applicant.applicantID + "\'" +')" class="outlined-btn d-inline" style="color: #2b2b2b; border-color: #2b2b2b; margin-right: 5px;"><i class="fa fa-eye" style="margin-right: 5px;"></i><label>View</label></div>'
											+ '<div id="res-viewBtn" onclick="downloadFile('+ "\'" + res[i].applicant.applicantID + "\'" +')" class="outlined-btn d-inline"  style="color: #2b2b2b; border-color: #2b2b2b; margin-right: 5px;"><i class="fa fa-download" style="margin-right: 5px;"></i><label>Download</label></div>'
										+ '</td>'
										+ '<td style="font-size: 14px;">'
